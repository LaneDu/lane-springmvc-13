...
<div>
    <h3>ajax json交互</h3>
    <fieldset>
        <input type="button" id="ajaxbtn2" value="ajax提交2"/>
    </fieldset>
</div>
<div>
    <h3>ajax json交互</h3>
    <fieldset>
        <input type="button" id="ajaxbtn3" value="ajax提交3"/>
    </fieldset>
</div>
...
<div >
    <a href="/demo/handle09">会出现异常</a>
    <a href="/demo/dispatcher01">转发01</a>
    <a href="/demo/dispatcher02?date=2021-4-2">转发02</a>
    <a href="/demo/redirect01?date=2021-4-2">重定向01</a>
    <a href="/demo/redirect02?date=2021-4-2">重定向02</a>
    <a href="/demo/redirect03?date=2021-4-2">重定向03</a>
</div>
</body>
<script>
    jQuery(function () {
